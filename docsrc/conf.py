...
htmlhelp_basename = 'Pyslice-datasettemplateenginedoc'
...
latex_documents = [
  ('index', 'Pyslice-datasettemplateengine.tex', u'Pyslice - dataset template engine Documentation',
...
man_pages = [
    ('index', 'pyslice-datasettemplateengine', u'Pyslice - dataset template engine Documentation',
     [u'Tim Cera, P.E.'], 1)
]
