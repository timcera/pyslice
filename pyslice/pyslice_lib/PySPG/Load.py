...
#    print len(ls)
        ...
        import os.path
        sys.stderr.write(" ... error reading file: %s, %d\n" %
        ...
        try:
            lsOut.append(
                [
                    eval(
                        xf.replace(
                            "x", str(line[0])).replace("y", str(line[1]))),
                    eval(
                        yf.replace("y", str(line[1])).replace("x", str(line[0])))
                ]
            )
